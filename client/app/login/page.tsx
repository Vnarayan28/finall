...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* Login Card */}
      <motion.div
        className={`relative backdrop-blur-xl rounded-3xl p-8 w-full max-w-md mx-4 ${isDarkMode
      ...
      >
        ...
        >
          <motion.div
            className={`p-4 rounded-2xl mb-4 ${isDarkMode
          ...
          <h1 className={`text-3xl font-bold bg-clip-text text-transparent ${isDarkMode
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          >
            ...
            <div className={`relative flex items-center rounded-xl transition-all ${isDarkMode
              ...
              <Mail className={`absolute left-4 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'
                }`} size={18} />
              <input
                type="email"
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className={`w-full pl-12 pr-4 py-3 bg-transparent outline-none ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
                  }`}
          ...
          >
            ...
            <div className={`relative flex items-center rounded-xl transition-all ${isDarkMode
              ...
              <Lock className={`absolute left-4 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'
                }`} size={18} />
              <input
                type="password"
                value={password}
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              disabled={isLoading}
              className={`w-full py-3 rounded-xl font-semibold relative overflow-hidden ${isDarkMode
          ...
          {message.text && (
            <motion.div
              ...
              className={`text-center text-sm font-medium mt-4 ${message.type === 'error' ? 'text-red-500' : 'text-green-500'
                }`}
            >
              {message.text}
            </motion.div>
